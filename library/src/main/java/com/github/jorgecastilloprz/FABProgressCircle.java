 ...
 */
@CoordinatorLayout.DefaultBehavior(FABProgressCircle.Behavior.class)
public class FABProgressCircle extends FrameLayout implements ArcListener, CompleteFABListener {
    ...
    public static class Behavior extends CoordinatorLayout.Behavior<FABProgressCircle> {
        public Behavior() {
            super();
        }
        ...
        @Override
        public boolean layoutDependsOn(CoordinatorLayout parent, FABProgressCircle child,
                                       View dependency) {
        ...
        public boolean onDependentViewChanged(CoordinatorLayout parent,
                                              FABProgressCircle child, View dependency) {
